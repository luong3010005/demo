            ...
            <div data-simplebar="" class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li class="menu-title">Thiên văn</li>


                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                                <i class="bx bx-store"></i>
                                <span>Các vì sao</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{route('management-show')}}">Danh sách</a></li>
                                <li><a href="{{route('management.create')}}">Thêm các vì sao</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a href="{{route('news.create')}}">Thêm mới tin tức</a></li>
                            </ul>
                        </li>
