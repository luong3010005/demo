        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="container mx-auto p-4">
                    ...
                    <form action="{{ route('update.celestialBody', $celestialBody) }}" method="POST"
                        ...
                        <div class="mb-4">
                            ...
                            <select name="type" id="type"
                                ...
                                <option value="hanh_tinh" {{ $celestialBody->type === 'hanh_tinh' ? 'selected' : '' }}>
                                    Hành Tinh</option>
                            </select>
                            @error('type')
                                <div class="text-danger">{{ $message }}</div>
                        ...
                        <div class="mb-4">
                            ...
                            @if($celestialBody->images)
                                <img src="{{ asset('storage/' . $celestialBody->images) }}" alt="{{ $celestialBody->name }}"
